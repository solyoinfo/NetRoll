...
{
    /// <inheritdoc />
    public partial class AddCatalogAndLocalization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CategoryTreeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_CategoryTrees_CategoryTreeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_CategoryTreeId",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Languages_OwnerUserId_Code",
                table: "Languages",
